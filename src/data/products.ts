...
import { giftSets1, giftSets2 } from '../assets/corporate_gifts/gift_sets';
...
// Office Stationery
import { welcomeKit1, welcomeKit3, welcomeKit4 } from '../assets/office_stationery/welcome_kit';
...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      'Give your guests advance notice with beautiful save-the-date cards. Available in multiple styles — modern, rustic, elegant, and traditional. Size of A5, contact sales team for customization',
    image: saveTheDate1,
     ...
     =================================================== */
  {
    ...
    price: 549,
    originalPrice: 700,
    discountLabel: '15% off on bulk orders (50+)',
    minQty: 1,
    maxQty: 2000,
    defaultQty: 50,
  ...
  },
  {
    ...
    image: welcomeKit1,
    gallery: [welcomeKit3, welcomeKit4],
  ...
  },
  {
    ...
    description:
      'Durable vinyl stickers for vehicles, shop windows, walls, and outdoor signage. Weather-resistant with vibrant colors that last. Price per feet',
    image: vinylSticker1,
